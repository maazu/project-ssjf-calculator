...
def multiply(number_one, number_two, save_file, show_output, path=DEFAULT_RESULT_SAVE_PATH,):
...
if __name__ == "__main__":
    ...
    multiply(number_one, number_two, save_file, show_output)
